...
<style>
    ...
    width: 0;
    height: 0;
    border-bottom: 49px solid #f2f2f2;
    ...
    .pageTitle-third a > h2 {
    font-family: 'Gordita Medium', sans-serif;
    color: #0089d0;
    font-size: 23px;
    text-transform: capitalize;
    }
    .pageTitle-third a > h2::before {
    content: '';
    position: absolute;
    top: 15px;
    left: 43px;
    width: 15px;
    height: 16px;
    background-image: url(../image/lef-icon.png);
    background-size: 100% 100%;
}

    @media only screen and (max-width: 767px) {
        .pageTitle, .pageTitle-sec, .pageTitle-third {
            width:100%;
            position: unset;
        }
        .pageTitle:after, .pageTitle-sec:after,  .pageTitle-third:after {
            display: none;
        }
        .pageTitle-sec, .pageTitle, .pageTitle-third {
            padding-left: 50px;
        }
        .pageTitle-sec a > h2 {
            font-size: 15px;
    ...
    @media only screen and (min-width: 767px) and (max-width: 980px) {
        ...
        .pageTitle-sec a > h2::before {
            top:3px;
        }
        .pageTitle a > h2::before {
            top:3px;
        }
        .pageTitle-third a > h2 {
            font-size: 15px;
    ...
    @media (width: 1024px) {
        .pageTitle-sec a > h2, .pageTitle a > h2, .pageTitle-third a > h2 {
            font-size: 20px;
        }
    }
  </style>
...
<body>
    ...
    <section class="divClear">
        ...
        <div class="container">
            <div class="pageContainer pb-5">
                <div class="pageTitle">
                    <a href="insurance.aspx">
                        <h2 class="wow fadeInDown" data-wow-duration="1.3s" data-wow-delay="0.3s">Insurance Companies</h2>
                    </a>
                </div>
                <div class="pageTitle-sec">
                    <a href="tpa.aspx"> 
                        <h2 class="wow fadeInDown" data-wow-duration="1.3s" data-wow-delay="0.3s">TPA Companies</h2>
                    </a>
                </div>
                <div class="pageTitle-third">
                    <a href="travelassistance.aspx"> 
                        <h2 class="wow fadeInDown" data-wow-duration="1.3s" data-wow-delay="0.3s">Travel Assistance</h2>
                    </a>
                </div>
                <!-- <div class="sub-title-head">Insurance Companies</div> -->
                <div class="row mx-0 wow fadeInDown insurance-list-img" data-wow-duration="1.3s" data-wow-delay="0.3s" style="top: 0px;">

                    <!-- New -->
                    <div class="col-md-4">
                        <img src="image/insurance/acko.png">
                        <p>Acko General Insurance Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/birla-sun.jpg">
                        <p>Aditya Birla Sun Life Insurance Company Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/bharti-general.jpg">
                        <p>Bharti AXA General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/cmsgi.jpg">
                        <p>Cholamandalam MS General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/edelweiss.png">
                        <p>Edelweiss General Insurance</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/fgti.jpg">
                        <p>Future Generali India Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/icici-lombard.jpg">
                        <p>ICICI Lombard General Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/iti.jpg">
                        <p>IFFCO-TOKIO General Insurance Co. Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/kotak-general-insurance.jpg">
                        <p>Kotak Mahindra General Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/landt.jpg">
                        <p>L&T General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/lgi.jpg">
                        <p>Liberty General Insurance Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/magma.png">
                        <p>Magma HDI General Insurance Company LTD.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/manipal-cigna.jpg">
                        <p>Manipal Cigna Health Insurance Company Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/max-bupa.jpg">
                        <p>Max Bupa Health Insurance Co. Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/national-insurance.jpg">
                        <p>National Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/rgi.jpg">
                        <p>Reliance General Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/royal.jpg">
                        <p>Royal Sundaram General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/sbi-general.jpg">
                        <p>SBI General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/TataAIG.png">
                        <p>Tata AIG Insurance </p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/new-india.jpg">
                        <p>The New India Assurance Co. Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/oriental-insurance.jpg">
                        <p>The Oriental Insurance Co. Ltd.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/united-india.jpg">
                        <p>United India Insurance Co. Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/star-health.jpg">
                        <p>Star Health and Allied Insurance Company Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/Bajaj-allianz.jpg">
                        <p>Bajaj Allianz General Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/digit.jpg">
                        <p>Go Digit General Insurance Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/Aditya-Birla-Health-Insurance-Company-Limited.jpg">
                        <p>Aditya Birla Health Insurance Company Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/universal-sompo.jpg">
                        <p>Universal Sompo General Insurance Co Ltd</p>
                    </div>
                    ...
                    <!--
                    <div class="col-md-4">
                        <img src="image/insurance/fhpl.jpg">
                        <p>Family Health Plan Insurance TPA Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/hh.jpg">
                        <p>Heritage Health Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/ami.jpg">
                        <p>Anmol Medicare Insurance TPA Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/swi.jpg">
                        <p>Safeway Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/bhartiaxa.jpg">
                        <p>Bharti Axa Life Insurance</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/ERICSON-INSURANCE-TPA-PVT.-LTD.jpg">
                        <p>Ericson Insurance TPA PVT.LTD.</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/mdhealth_apr19.jpg">
                        <p>MDIndia Health Insurance TPA PVT.LTD</p>
                    </div>
                    -->
                    
                </div>
                 <p class="px-3" style="font-size: 12px; font-style: italic;">
                        Remarks:Cashless Facilities is subject to Hospital empaneled TPA only
                    </p>
            </div>
        </div>
    </section>
