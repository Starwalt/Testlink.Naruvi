...
-->
        ...
        <div class="h-fter py-2">
            <div class="container-page">
                <div class="col-md-4 py-0 text-md-left text-center">
                    <p>&copy; 2020 Naruvi Hospitals</p>
                </div>
                <div class="col-md-4 py-0">
                    <ul class="p-0 mx-auto mb-auto mt-1 socialIcon">
                ...
                <div class="col-md-4 py-0 text-md-right text-center">
