                    ...
                    <div class="col-lg-7 col-md-7 col-sm-6">
                        ...
                        <div class="">
                             <div class="col-lg-6 col-md-12 col-sm-12 no-padding-left position-relative">
                                ...
                                <p class="text-large black-text letter-spacing-2 no-margin-bottom">Lorem ipsum
                                </p>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 no-padding-left">
                                <p class="black-text"><strong>Job Description</strong></p>
...
<!--                         <div class="wide-separator-line no-margin-lr margin-ten"></div> -->
                        ...
                        <!-- <div class="clearfix"> -->
                             <div class="col-lg-6 col-md-12 col-sm-12 no-padding-left">
                                ...
                                <div class="separator-line bg-black no-margin-lr"></div>
                                <p class="text-large black-text letter-spacing-2 no-margin-bottom">Lorem ipsum</p>
                        ...
                        <div class="bg-gray career-form p-4">
                            ...
                            <!-- form -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txtName" type="text" id="txtName" class="input-round med-input text-capitalize" autocomplete="off">
                                </div>
                                <div class="form-group">

                                    <label class="text-uppercase career-font">Email</label>
                                    <input name="txtEmailId" type="text" id="txtEmailId" class="input-round med-input" autocomplete="off">
                                </div>
                                <div class="form-group">

                                    <label class="text-uppercase career-font">Phone Number</label>
                                    <input name="" type="text" id="" class="input-round med-input" autocomplete="off">
                                </div>
                            
                                <div class="form-group">
                                    <label class="text-uppercase career-font">Gender</label>
                                ...
                                <div class="form-group">
                                    <label class="text-uppercase career-font">City</label>
                                    <input name="" type="text" id="" class="input-round med-input" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label class="text-uppercase career-font">State</label>
                                    <select name="" class="custom-select">
                                ...
                                <div class="form-group">
                                    <label class="text-uppercase career-font">Current Institution</label>
                                    <input name="" type="text" id="" class="input-round med-input" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label class="text-uppercase career-font">Current Designation</label>
                                    <input name="" type="text" id="" class="input-round med-input" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label class="text-uppercase career-font">Experience</label>
                                    <input name="" type="text" id="" class="input-round med-input" autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12 px-0 pt-0">
                                          <input name="txtVerifyCode" type="text" id="txtVerifyCode" class="input-round med-input" autocomplete="off" style="text-transform: unset;">
                                      </div>
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="btnSubmit" value="Submit" id="btnSubmit" class="highlight-button-dark btn btn-small button xs-margin-bottom-five">
