<%@ Page Language="C#" AutoEventWireup="true" CodeFile="appointmenttest.aspx.cs" Inherits="appointmenttest" %>
              ...
              <input type="hidden" id="regDate" name="Registered Date" />
                ...
                <div class="modal-body px-4">
                    ...
                    <div class="second-sec-form" id="second-sec-form" style="display: none;">
                        ...
                        <div class="form-group">
                            <select class="custom-select" id="Consultation" name="Consultation">
