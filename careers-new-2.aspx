...
<link href="css/mdtimepicker.css" rel="stylesheet" type="text/css">
    ...
    <link href="css/careers-2.css" rel="stylesheet">
...
border-radius: 4px;">Apply Now</a></h2>
                    ...
                    <!--=========== ENDS: APPLY NOW FORM ==============-->
                     ...
                     <div class="col-lg-12">
                        <div class="pb-5 pt-4 lightGreyBg">
                            <h2 class="pl-3 pb-3 mb-0" style="font-weight: bold; font-size: 18px;">Vacant Positions</h2>
                            <div class="container">
                                <div class="accordion" id="accordionExample">
                                    <div class="card careersBox px-4 py-4">
                                        <div class="" id="jobOne">
                                            <div class="mb-0">
                                                <button class="w-100 text-left" type="button" data-toggle="collapse"
                                                    data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <div class="semiBoldFont f-20 ak-B m-0 d-flex align-items-center">
                                                        <div class="mr-2 mblNone">
                                                            <img src="./image/redlabel.png" />
                                                        </div>
                                                        <div> Job Title 1 </div>
                                                    </div>
                                                </button>
                                        ...
                                        <div id="collapseOne" class="collapse" aria-labelledby="jobOne" data-parent="#accordionExample">
                                            <div class="card-body mt-3 p-0 border-0 bgTransparent lsp-05">
                                                <div class="content pt-3">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                                    <p class="mt-2 mb-0 font-weight-bold">Experience : </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card careersBox p-4">
                                        <div class="" id="jobTwo">
                                            <div class="mb-0">
                                                <button class="w-100 text-left" type="button" data-toggle="collapse"
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="jobTwo" data-parent="#accordionExample">
                                            <div class="card-body mt-3 p-0 border-0 bgTransparent lsp-05">
                                                <div class="content pt-3">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                                                    <p class="mt-2 mb-0 font-weight-bold">Experience : </p>
                                    ...
                                    <div class="card careersBox p-4">
                                        ...
                                        <div id="collapseThree" class="collapse" aria-labelledby="jobThree"
