                        ...
                        <ul class="menuBar hvr-underline-from-center">
                            ...
                            <li class="dropDownHover"><a href="javascript:void(0);">About</a><span class="dropicon"><i class="fa fa-angle-down" aria-hidden="true"></i></span>
                                <ul class="dropDown hvr-sweep-to-bottom">
                                    <li><span>
                                        <img src="image/arrow.png"></span><a href="about-naruvi.aspx">Naruvi</a></li>
                                    <li><span>
                                        <img src="image/arrow.png"></span><a href="the-board.aspx">The Board</a></li>
                                    <li><span>
                                        <img src="image/arrow.png"></span><a href="about-hfhs.aspx">Henry Ford Health System</a></li>
                                    <li><span>
                                        <img src="image/arrow.png"></span><a href="about-vellore.aspx">Vellore</a></li>
                                </ul>
                            </li>
                                ...
                                <div class="form formNew">
                                    ...
                                    <div class="col-12">
                                        <div class="label-txt">
                                            ...
                                            <span>
                                                <asp:RequiredFieldValidator ID="reqfv" runat="server" CssClass="error404" Display="Dynamic" ControlToValidate="txtName" ValidationGroup="btn" ErrorMessage="Enter your Name"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="regfv" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ValidationExpression="^[a-zA-Z'.\s]{3,54}" ControlToValidate="txtName" ErrorMessage="Minimum 3 & Maximum 54 Characters Allowed & Symbols are not allowed"></asp:RegularExpressionValidator>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="label-txt">
                                            ...
                                            <span>
                                                <asp:RequiredFieldValidator ID="reqfv1" runat="server" CssClass="error404" Display="Dynamic" ControlToValidate="txtEmailId" ValidationGroup="btn" ErrorMessage="Enter your Email Id"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="regfv1" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="txtEmailId" ErrorMessage="Enter Valid Email Id"></asp:RegularExpressionValidator>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="label-txt">
                                            ...
                                            <span>
                                                <asp:RequiredFieldValidator ID="reqfv2" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ControlToValidate="txtPhone" ErrorMessage="Enter your Mobile No."></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="regfv2" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ValidationExpression="[0-9]{8,13}" ControlToValidate="txtPhone" ErrorMessage="Enter Valid Mobile No."></asp:RegularExpressionValidator>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-12 ">
                                        <div class="label-txt">
                                            ...
                                            <span>
                                                <asp:RequiredFieldValidator ID="reqfv3" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ControlToValidate="txtMessage" ErrorMessage="Enter your Message"></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-12 pad-l0">
                                        ...
                                        <div class="col-7 pad-l0 inputType pad-r0">
                                            <div class="label-txt pad-r0">
                                                ...
                                                <span>
                                                    <asp:RequiredFieldValidator ID="reqfv4" runat="server" CssClass="error404" Display="Dynamic" ValidationGroup="btn" ControlToValidate="txtVerify" ErrorMessage="Enter Verifcation Code"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="butttonNew">
                                                <asp:Button ID="btnSend" runat="server" CssClass="btn" ValidationGroup="btn"
