...
<body>
    <form id="form1" runat="server">
        ...
        <div class="clearfix"></div>
        <div class="banner">
            <p class="noti wow slideInRight" data-wow-duration="2s" data-wow-delay="7s"><a class="wow fadeIn" data-wow-duration="0s" data-wow-delay="7s" href="#news-pg">Check out our February 2019 Newsletter!</a></p>
            ...
            <div id="wowslider-container1">
                <div class="ws_images">
                    <ul>
                        <li>
                            <img src="image/Slider1.jpg" alt="Naruvi Hospitals" title="World class health care, now in Vellore <br> <span> (To be operational in December 2019)</span>" id="wows1_0" /></li>
                        <li>
                            <img src="image/slider-02.jpg" alt="Naruvi Hospitals" title="Care... when you  need it the most" id="wows1_1" /></li>
                        <li>
                            <img src="image/slider-03.jpg" alt="Naruvi Hospitals" title="Bringing your smile back... above all" id="wows1_2" /></li>
                    </ul>
                </div>
                <div class="ws_bullets">
                    <div><a href="#" title="Experience Expertise-1"><span>1</span></a> <a href="#" title="Experience Expertise-2"><span>2</span></a> <a href="#" title="Experience Expertise-2"><span>2</span></a> </div>
                </div>
                <div class="ws_script" style="position: absolute; left: -99%"><a href="http://wowslider.net">image slider</a> by WOWSlider.com v8.8</div>
        ...
        <div class="wel-text">
            <div class="container-page">
                <div class="well">
                    <h2 class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s"><strong>Naruvi Hospitals... The journey envisaged... </strong></h2>
                    <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                        Naruvi Hospitals is being created as a destination for world class health care, with the latest in medical
        technology, the best equipment to facilitate quick and accurate diagnosis, the expertise and equipment to
        ...
        <div class="wel-page">
            <div class="wel-cont">
                <ul class="wel-list">
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="0.3s"><span class="counter">24</span> X <span class="counter">7</span></span></h2>
                        <p>Emergency Care </p>
                    </li>
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="0.6s"><span class="counter">475</span>+</span></h2>
                        <p>Beds</p>
                    </li>
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="0.9s"><span class="counter">03</span></span> </h2>
                        <p>Research Units</p>
                    </li>
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="1.2s"><span class="counter">75</span>+</span></h2>
                        <p>Experts</p>
                    </li>
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="1.8s"><span class="counter">25</span></span></h2>
                        <p>Specialties</p>
                    </li>
                    <li class="wel-txt">
                        <h2><span class="wow fadeInDown" data-wow-duration="2s" data-wow-delay="1.5s"><span class="counter">12</span></span></h2>
            ...
            <div class="container-page">
                        ...
                        <div class="items">
                            <a href="pdf/Naruvi_Print_April_2018.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    <img src="image/home/february_2019.jpg" alt="news" />
                                    <div class="icon"><a href="pdf/Naruvi_Print_February_2019.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>February - 2019</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/Naruvi_Print_April_2018.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    ...
                                    <div class="icon"><a href="pdf/Naruvi_Print_April_2018.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>April  - 2018</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/Naruvi_Print_March_2018.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    ...
                                    <div class="icon"><a href="pdf/Naruvi_Print_March_2018.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>March  - 2018</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/Naruvi_Print_February_2018.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    ...
                                    <div class="icon"><a href="pdf/Naruvi_Print_February_2018.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>February  - 2018</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/January-2018.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    ...
                                    <div class="icon"><a href="pdf/January-2018.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>January  - 2018</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/December-2017.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.3s">
                                    ...
                                    <div class="icon"><a href="pdf/December-2017.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>December - 2017</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/November-2017.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                                    ...
                                    <div class="icon"><a href="pdf/November-2017.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>November - 2017</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/October-2017.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="0.9s">
                                    ...
                                    <div class="icon"><a href="pdf/October-2017.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>October - 2017</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/September-2017.pdf" target="_blank">
                                <div class="news-iteam wow fadeIn" data-wow-duration="2s" data-wow-delay="1.2s">
                                    ...
                                    <div class="icon"><a href="pdf/September-2017.pdf"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>September - 2017</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/August-2017.pdf" target="_blank">
                                <div class="news-iteam">
                                    ...
                                    <div class="icon"><a href="pdf/August-2017.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>August - 2017</p>
                                    </div>
                                </div>
                        ...
                        <div class="items">
                            <a href="pdf/July-2017.pdf" target="_blank">
                                <div class="news-iteam">
                                    ...
                                    <div class="icon"><a href="pdf/July-2017.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a></div>
                                    <div class="event-des">
                                        <p>July - 2017</p>
                                    </div>
                                </div>
                ...
                <div class="subscribe">
                    ...
                    <div style="display: inline">
                        <asp:TextBox ID="txtNewsletterEmail" runat="server" CssClass="input-email" placeholder="Type your email here" autocomplete="off"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="Req1" runat="server" ControlToValidate="txtNewsletterEmail"
                            ErrorMessage="Enter your email id" Display="Dynamic" ForeColor="#e62626" Font-Size="13px"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="regfv1" runat="server" ForeColor="#e62626" Font-Size="13px" Display="Dynamic"
                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                            ControlToValidate="txtNewsletterEmail" ErrorMessage="Enter Valid Email Id"></asp:RegularExpressionValidator>
                    </div>
                    <asp:Button ID="btnEmailSubscription" runat="server" Text="Go" CssClass="button-newsletter" OnClick="btnEmailSubscription_Click" />
                </div>
            </div>
        </div>
        <div class="clear"></div>
            ...
            <div class="container-page">
                <div class="abt-1">
                    <div class="scroll-left">
                        <div class="" id="abt">
                            <div class="items scroll-iteam wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                    ...
                    <div class="scroll-right">
                        ...
                        <p>Founded in 1915 by auto pioneer Henry Ford and now one of USA's leading health care providers, Henry Ford Health System is a not-for-profit corporation managed by Chief Executive Officer Wright L. Lassiter, III and governed by a 17-member Board of Trustees, with volunteer-led advisory and affiliate boards providing additional leadership.</p>
                        <a class="more-1" href="about-hfhs.html">[ MORE ]</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="h-sbfter">
            <div class="fter-txt">
                <p class="wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s"><i class="fa fa-map-marker l-icn"></i><span>72/1B2, Collector Office Road, Bangalore-Chennai National Highway (NH 48), Vellore – 632 004</span> <a href="#"><i class="fa fa-envelope m-icn"></i><span>info@naruvi.com</span> </a></p>
            </div>
        </div>
