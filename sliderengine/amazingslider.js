    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            createNavBullet: function(index) {
                ...
                var $bullet = $("<div class='amazingslider-bullet-" + this.id + "-" + index + "' style='position:relative;float:" + f + ";" + b + "margin-" + marginF + ":" + spacing + "px;width:" + w + "px;height:" + 64 + "px;cursor:pointer;'></div>");
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $(imgLoader).load(function() {
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            else style = "max-width:none !important;width:100%;height:auto;margin-left:-" + Math.floor(this.width / this.height * instance.options.navimageheight / 2 - instance.options.navimagewidth / 2) + "px";
