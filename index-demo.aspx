    ...
    <form id="form1" runat="server">
                        ...
                        <ul class="menuBar hvr-underline-from-center">
                            ...
                            <li class="dropDownHover"><a href="javascript:void(0);">About</a><span class="dropicon"><i
                                ...
                                <ul class="dropDown hvr-sweep-to-bottom">
                                    <li><span>
                                            <img src="image/arrow.png"></span><a href="about-naruvi.html">Naruvi</a>
                                    </li>
                                    <li><span>
                                            <img src="image/arrow.png"></span><a href="the-board.html">The Board</a>
                                    </li>
                                    <li><span>
                                            <img src="image/arrow.png"></span><a href="about-hfhs.html">Henry Ford
                                            Health System</a></li>
                                    <li><span>
                                            <img src="image/arrow.png"></span><a href="about-vellore.html">Vellore</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="banner">
            <p class="noti wow slideInRight" data-wow-duration="2s" data-wow-delay="7s"><a class="wow fadeIn"
                    data-wow-duration="0s" data-wow-delay="7s" href="#news-pg">Check out our January 2020
                    Newsletter!</a></p>
            ...
            <div id="wowslider-container1">
                    ...
                    <ul>
                        <li class="whiteColor">
                            <img src="image/Reception.png" alt="Naruvi Hospitals"
                                title="World class health care, now in Vellore <br> <span> (To be operational in Mid 2020)</span>"
                ...
                <div class="ws_bullets">
                    <div><a href="#" title="Experience Expertise-1"><span>1</span></a> <a href="#"
                            title="Experience Expertise-2"><span>2</span></a> <a href="#"
                            title="Experience Expertise-2"><span>2</span></a>
                            <a href="#"
                            title="Experience Expertise-2"><span>2</span></a>
                            <a href="#"
                            title="Experience Expertise-2"><span>2</span></a> </div>
                </div>
        ...
        <div id="ac-wrapper" style='display:none'>
            <div id="popup">
                <div>
                    <a target="_blank">
                    <img src="./image/Hiring.jpg" class="w-100" />
                    </a>
                </div>
