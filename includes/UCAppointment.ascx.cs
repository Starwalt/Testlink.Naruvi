...
public partial class includes_UCAppointment : System.Web.UI.UserControl
{
    ...
    public string SendThankyou(string Name, string appointmentDate, string appointmentTime, string emailId)
    {
        ...
        SendMail(emailId, "Your Appointment Request Registered - Thank You.", emailBody);
    ...
    public string SendFormDetails()
    {
        ...
        SendMail("preethisampath@parampriti.com", "New Appointment Request", emailBody);
