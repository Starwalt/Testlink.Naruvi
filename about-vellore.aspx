<%@ Page Language="C#" AutoEventWireup="true" CodeFile="about-vellore.aspx.cs" Inherits="about_vellore" %>
    ...
    <div class="headerRight">
      ...
      <div class="nav-wrap">
        ...
        <ul class="menuBar hvr-underline-from-center">
          ...
          <li><a href="default.aspx#news-pg">News update</a></li>
...
<section class="divClear">
  ...
  <div class="container">
    <div class="pageContainer">
      <div class="pageTitle">
        <h2 class="wow fadeInDown" data-wow-duration="1.3s" data-wow-delay="0.3s">About Vellore</h2>
      </div>
      <div class="mar-top30"></div>
      <div class="tourium">
        <p class="wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.6s">Vellore City's proximity to two major Metropolitan Cities Chennai and Bengaluru is an added advantage. Both these Cities have International Airports. Vellore is just 130 km away from Chennai and 210 km from Bengaluru. Vellore City is located on the National Highway and is well connected by Road and Rail Transport.</p>
      </div>
      <div class="aboutVellore">
        <div class="touriumDetails divClear why">
          <h4>Why Vellore?</h4>
          <div class="col-6 velloreLeft tour">
            <ul class="list wow fadeIn" data-wow-duration="1.3s" data-wow-delay="0.9s">
              <li>Chennai - Vellore Region is known as the health care capital of India</li>
              <li>It is a popular destination for medical tourists from abroad and India for many years now. </li>
              <li>50% of all foreign patients in India are treated in this region.</li>
              <li>This region has more Multi and Super-speciality hospitals that bring in sizeable numbers of international patients every day.</li>
            </ul>
          </div>
          <div class="col-6 velloreRight tour">
            <ul class="list wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.8s">
              <li>According to a study by the Confederation of Indian Industries (CII), more than 6 lakh tourists visit the state every year.</li>
              <!-- <li>Chennai – Vellore region attracts more than 45% of health tourists from abroad arriving in the country and 40-50% of domestic health tourists.</li> -->
              <li>Factors behind the tourists’ inflow in this region include low costs, little waiting times and excellent facilities offered at these speciality hospitals.</li>
            </ul>
          </div>
        </div>
      </div>
