    ...
    <section class="divClear">
        ...
        <div class="container">
            <div class="pageContainer pb-5">
                ...
                <div class="sub-title-head">Third Party Administrator (TPA)</div>
                <div class="row mx-0 wow fadeInDown insurance-list-img" data-wow-duration="1.3s" data-wow-delay="0.3s" style="top: 0px;">
                    ...
                    <div class="col-md-4">
                        <img src="image/insurance/ei.jpg">
                        <p>Ericson Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <img src="image/insurance/health-insu.jpg">
                        <p>Health Insurance TPA of India Limited</p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <img src="image/insurance/Vidal.jpg">
                        <p>Vidal Health Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/Vipul.jpg">
                        <p>Vipul Medcorp Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/good-health.jpg">
                        <p>Good Health Insurance TPA Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/paramount.jpg">
                        <p>Paramount Health Services & Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/med-save.jpg">
                        <p>Medsave Health Insurance TPA Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/united-parekh.jpg">
                        <p>United Health Care Parekh Insurance TPA Private Limited</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/Medi-Assist.jpg">
                        <p>Medi Assist Insurance TPA Pvt. Ltd</p>
                    </div>
                    <div class="col-md-4">
                        <img src="image/insurance/raksha-tpa.jpg">
